...
#-----------------------------------------------------------------------------------------
def fit(freq, num_of_n, delta_nu, num_of_dif2=None, freqDif2=None, icov=None, method='FQ', 
        n_rln=1000, tol_grad=1e-3, regu_param=7., n_guess=200, tauhe=None, dtauhe=None, 
        taucz=None, dtaucz=None):
    '''
